...
export async function interpretWithLlm(
  ...
  const prompt = renderTemplate(
    activePrompt.body,
    {
      ...
      cognitive_score: findDimScore(score, "Cognitive Clarity", nameById),
      cognitive_max: findDimMax(score, "Cognitive Clarity", nameById),
      cognitive_band: findDimBand(score, "Cognitive Clarity", nameById),
      relational_score: findDimScore(score, "Relational Influence", nameById),
      relational_max: findDimMax(score, "Relational Influence", nameById),
      relational_band: findDimBand(score, "Relational Influence", nameById),
      inner_score: findDimScore(score, "Inner Mastery", nameById),
      inner_max: findDimMax(score, "Inner Mastery", nameById),
      inner_band: findDimBand(score, "Inner Mastery", nameById),
