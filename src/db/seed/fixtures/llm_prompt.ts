...
export const LLM_INTERPRETATION_PROMPT_V1 = {
  ...
  body: [
    ...
    "- Cognitive Clarity: {{cognitive_score}}/{{cognitive_max}} · {{cognitive_band}}",
    "- Relational Influence: {{relational_score}}/{{relational_max}} · {{relational_band}}",
    "- Inner Mastery: {{inner_score}}/{{inner_max}} · {{inner_band}}",
    ...
    "6. The lowest_dimension MUST exactly match one of: Cognitive Clarity, Relational Influence, Inner Mastery.",
    "",
